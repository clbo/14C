...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void Button_upload_Click(object sender, EventArgs e)
    {
        ...
        if (File.Exists(Server.MapPath("~/Images/upload/") + FileUpload_img.FileName))
        {
            ...
            MakeThumb(FileUpload_img.FileName, "/Images/Upload/", 120, "/Images/Upload/Thumbs/");
    ...
    protected void Button_Dynamisk_filenavn_Click(object sender, EventArgs e)
    {
        ...
        FileUpload_img.SaveAs(Server.MapPath("~/Images/upload/") + billedUrl);
    ...
    protected void Button_upload_dato_Click(object sender, EventArgs e)
    {
        ...
        if (File.Exists(Server.MapPath("~/Images/upload/") + billedUrl))
        {
            SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["connStr"].ToString());
            SqlCommand cmd = new SqlCommand();
            cmd.Connection = conn;
