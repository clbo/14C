...
<body>
    ...
    <div>
        ...
        <p>
            <asp:Repeater ID="Repeater_images" runat="server" DataSourceID="SqlDataSource1">
                <ItemTemplate>
                    <p>
                        <img src='Images/upload/<%#Eval("ImageFileName") %>' />
                        -  <asp:LinkButton ID="LinkButton_slet" runat="server" CommandArgument='<%# Eval("ImageFileName") %>'
                            OnCommand="LinkButton_slet_Command" OnClientClick='confirm("Er du sikker på at du vil slette billedet?");'>Slet</asp:LinkButton>
                        </p>
                </ItemTemplate>
            </asp:Repeater>
